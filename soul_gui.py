#!/usr/bin/env python3
"""
The Computer's Soul + CPU/Memory graphs + Weather (London by default)
+ hardware temperatures + clock

A lightweight, always-on-top system monitor with a soul.
"""
...
class SoulMonitor(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("The Computer's Soul")
        ...
        self.poems = {
            "calm": [
                "The system breathes calmly...",
                "Silence is a luxury we deserve.",
                "Bytes dance slowly and beautifully.",
                "Today the world feels light."
            ],
            "medium": [
                "Something moves beneath the surface...",
                "The processor starts thinking harder.",
                "RAM holds memories that weigh.",
                "Balance is fragile, but still there."
            ],
            "high": [
                "My heart beats faster.",
                "Too many thoughts at once...",
                "The system is starting to sweat.",
                "Please... a little air."
            ],
            "critical": [
                "Everything is falling apart into particles!",
                "I... can't take it anymore...",
                "The world has become too heavy.",
                "Help... or at least a restart."
            ],
            "night": [
                "Sleeping sweetly...",
                "Even the electrons rest.",
                "Quiet... almost nothing is happening.",
                "Dreaming of empty processes."
            ]
        }
        ...
        self.weather_interval = 1800  # 30 minutes

        # === TOP SECTION ===
        self.title_label = tk.Label(
            self, text="THE COMPUTER'S SOUL",
        ...
        # freemeteo.bg link (default: London)
    ...
    def _get_hardware_temps(self):
        ...
        try:
            ...
            pass
        return " | ".join(temps) if temps else "Temp: no data"
    ...
    def _update_weather(self):
        ...
        try:
            # Default: London, UK
            # Change latitude, longitude and timezone to switch city
            url = (
